...
export default function CTASection() {
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-100 to-slate-50">
      <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-black leading-tight">
          Ready to Read and Join the Discussion?
        </h2>
        <p className="text-sm sm:text-base md:text-lg text-black/70 max-w-2xl mx-auto">
          Join thousands of students who already enjoy the convenience of Naratama's digital library
        </p>
