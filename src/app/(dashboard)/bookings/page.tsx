...
// import { typography } from "@/styles/typography"
// import { BookingCard } from "@/components/bookings/BookingCard"
// import type { Booking, User } from "@/types" // <-- Import User
// import { getAuthToken } from "@/lib/auth"
// import { useRouter } from "next/navigation"
// import { colors } from "@/styles/colors"
...
//     const router = useRouter();
//     const [bookings, setBookings] = useState<Booking[]>([])
//     const [currentUser, setCurrentUser] = useState<User | null>(null); // <-- STATE BARU
//     const [isLoading, setIsLoading] = useState(true)
//     const [error, setError] = useState<string | null>(null)
//     const [searchTerm, setSearchTerm] = useState("")
//     const [filter, setFilter] = useState("all")
...
//             setIsLoading(true)
//             try {
//                 // --- KITA UBAH INI: Kita fetch /me dan /list BARENGAN ---
...
//                     const errorData = await userRes.json() // Ambil error dari salah satunya
...
//                 setCurrentUser(userData); // <-- SIMPEN DATA USER
...
//         // 1. Kalo lu BUKAN admin, paksa filter cuma bookingan lu
//         // ATAU Kalo lu ADMIN tapi BUKAN di halaman admin, kita filter juga
//         // (Kita asumsi halaman ini SELALU "My Bookings")
//         if (currentUser) {
//             list = list.filter(b => b.user.id === currentUser.id || (b.user as any)._id === currentUser._id);
//         }
//         // 2. Kalo lu ADMIN, lu liat semua (gak usah di-filter by ID)
//         // --- ----------------- ---
...
//         return list
//     }, [bookings, filter, searchTerm, currentUser]) // <-- Tambah currentUser
...
//             if (sortBy === "dateDesc") return dateB - dateA
//             if (sortBy === "dateAsc") return dateA - dateA // <-- ANJIR INI BUG JUGA, harusnya dateA - dateB
//             return 0
//         })
//     }, [filteredBookings, sortBy])
