...
function Dashboard() {
    ...
    const searchParams = useSearchParams(); // Aman dipake di dalem Suspense
    ...
    useEffect(() => {
        ...
        ;(async () => {
            try {
                if (!API_URL || !token) {
                    // Kalo gak ada token, gak usah fetch /me, biarin useEffect utama yg nendang
    ...
    return (
        <div style={{ backgroundColor: colors.bgPrimary }}>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 pb-16">
                ...
                <Section title="Latest Announcements" description="Stay updated with library news" viewAllHref="/announcements">
                    {/* --- FIX DI SINI: grid-cols-1 (biar gak aneh) atau 2 --- */}
